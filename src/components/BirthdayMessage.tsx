  ...
  return (
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 text-center pointer-events-none px-4">
      <div className="bg-background/40 backdrop-blur-sm rounded-3xl px-8 py-6 border border-primary/30 shadow-2xl">
        <h1 className="font-script text-5xl md:text-7xl lg:text-8xl text-secondary font-bold tracking-wide">
          Happy
        </h1>
        <h2 className="font-script text-6xl md:text-8xl lg:text-9xl bg-gradient-to-r from-primary via-birthday-rose to-accent bg-clip-text text-transparent font-bold mt-2">
          Birthday
        </h2>
